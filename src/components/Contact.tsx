      ...
      <div className="relative z-10">
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-20">
          ...
          <form className="fade-trigger space-y-6">
            ...
            <button
              type="submit"
              className="w-full md:w-auto px-8 py-3 bg-black text-white rounded-full text-lg font-medium hover:bg-black/90 transition-transform hover:-translate-y-1.5 cursor-pointer duration-300 border border-white/60"
            >
              Pošalji poruku
            </button>
          </form>
            ...
            <div className="grid grid-cols-2 gap-3 text-xl">
              ...
              <button
                className="flex items-center gap-3 px-6 py-3 rounded-full text-white text-xl font-medium 
                           ...
                           hover:bg-green-300 hover:text-black transition delay-75 duration-300  cursor-pointer backdrop-blur-sm"
              >
                <svg
              ...
              <button
                className="flex items-center gap-3 px-6 py-3 rounded-full text-white text-xl font-medium 
                           bg-white/10 border border-white/40 
                           hover:bg-amber-300 hover:text-black transition delay-75 duration-300  cursor-pointer backdrop-blur-sm"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 512 512"
              ...
              <button
                className="flex items-center gap-3 px-6 py-3 rounded-full text-white text-xl font-medium 
                           bg-white/10 border border-white/40 
                           hover:bg-red-300 hover:text-black transition delay-75 duration-300  cursor-pointer backdrop-blur-sm"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 512 512"
              ...
              <button
                className="flex items-center gap-3 px-6 py-3 rounded-full text-white text-xl font-medium 
                           bg-white/10 border border-white/40 
                           hover:bg-blue-400 hover:text-black transition delay-75 duration-300  cursor-pointer backdrop-blur-sm"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 320 512"
